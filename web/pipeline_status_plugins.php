...
<!--            <link rel="stylesheet" type="text/css" href="stylesheet.css">-->
	    ...
	    td { white-space:pre-wrap; word-wrap:break-word }
                ...
                <title>NEMAR pipeline plugins status</title>
        </head>

        <body>
    <div class="container p-3">
        <div class="border border-primary"><h1 class="display-4 text-center text-bold text-primary"><strong>NEMAR pipeline plugins status</strong></h1></div>
    </div>
    <div class="container">
        <p class="text-center lead" id="listalldescription">Status of running NEMAR pipeline plugins</p>
    </div>
    <br>
 .  <br>
    <div class="container">
    ...
    <script>
	    ...
	    $.ajaxSetup ({
	      ...
	      cache: false
            ...
            $("#statusTable").load('pipeline_status_plugins_all.html', function() {

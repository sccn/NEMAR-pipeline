...
dsfolders = {'ds003343', 'ds003506', 'ds003690', 'ds004315', 'ds004575', 'ds004147', 'ds004262','ds004348', 'ds002893'}
for i=1:numel(dsfolders)
    dsnumber = dsfolders{i};
    
	fprintf('Processing %s\n', dsnumber);
    try
        run_pipeline(dsnumber, 'preprocess', false, 'vis', false, 'dataqual', true, 'maxparpool', 0, 'modeval', 'resume');
    catch ME
        fprintf('%s\n', ME.identifier);
        fprintf('%s\n', ME.message);
        fprintf('%s\n', ME.getReport());
